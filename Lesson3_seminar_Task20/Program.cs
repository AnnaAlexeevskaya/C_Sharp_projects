...
// double sqrt = Math.Sqrt(5); // корень квадратный
// double pow = Math.Pow(3, 5); // возведение в степень 
// Console.WriteLine(sqrt);
// Console.WriteLine(pow);

// double d = 5.09983461; // 5.09
// double dRound = Math.Round(d, 5, MidpointRounding.ToZero); - с параметром округление- отбрасывает лишние знаки

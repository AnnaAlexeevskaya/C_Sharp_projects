...
Console.WriteLine("Введите параметры 1 уравнения: b1");
int b1 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите параметры 1 уравнения: k1");
int k1 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите параметры 2 уравнения: b2");
int b2 = Convert.ToInt32(Console.ReadLine());

Console.WriteLine("Введите параметры 2 уравнения: k2");
int k2 = Convert.ToInt32(Console.ReadLine());

if (k1 == k2)  Console.WriteLine("Решение не существует");
